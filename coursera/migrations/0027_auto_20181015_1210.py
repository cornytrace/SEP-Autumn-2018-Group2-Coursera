...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('coursera', '0026_create_course_progress_index'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(max_length=50, primary_key=True, serialize=False)),
                ('option_id', models.CharField(db_column='assessment_option_id', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('two_let', models.CharField(max_length=2, primary_key=True, serialize=False)),
        ...
        migrations.AlterModelTable(
            ...
            table='discussion_questions_view',
        ),
        migrations.AlterModelTable(
            name='itemrating',
            table='feedback_item_ratings_view',
        ),
    ]
